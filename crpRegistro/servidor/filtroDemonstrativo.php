...
<tbody>
      ...
      <td   class="td-corpo"style="text-align: center"> <strong><?php if($numItemDG < 10) {
                                                      echo "0", $numItemDG;
                                                            ...
                                                            ?>  </strong> </td>
      <td  class="td-corpo" id="desc" style="width:25%;text-align: justify;font-size:medium;"> <?php echo $descItemDemo?> </td>
...
<div style="text-align:center">
     <img width=30 height=30 src="/imagens/loading.gif" alt="Esperando resposta..."/>
</div>
<?php endif;
?>
