...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary" style="background-color: #99d4c4 !important; border-bottom: 0.5px solid #99d4c4 !important">
    <div class="container-fluid">
        ...
        <li class="nav-item">
        <h5> <a class="nav-link active" aria-current="page" href="./usuarios.php"><strong>Consultar usuário</strong></a></h5>

        </li>
        </ul>
        <div class="d-flex">  
            <a class="navbar-brand" href="#"><strong> Usuário: <font style="color: #54AEE6;"><?php echo $logado?></strong></font>  </a>    
