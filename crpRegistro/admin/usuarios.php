...
?>
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex">  
            <a class="navbar-brand" href="#"><strong><font style="color:white"> Usuário: </font> <font style="color: #54AEE6;"><?php echo $logado?></strong></font></a>    
    ...
    <div class="container-table" style="margin: 2% 3% 2% 3%;">
    <div class="table-responsive" style="background-color: transparent !important">
        ...
        <caption style=" text-align: center;color: #008b8b; border-top-left-radius: 15px !important; border-top-right-radius: 15px !important; background-color: white; width:250px; margin: auto"><h5>Usuários Cadastrados</h5></caption>
            <thead>
            <tr id="tit">
    ...
    <tr class="tr-table-user" id="itens">
        ...
        <td class="td-corpo" style="text-align:center; vertical-align:middle;width:70px; height:30px;padding: 7px;"> <a class="button floatLeft" href="alterar.php?id=<?php echo $id?>"> Alterar<!--  <img style="margin-left:45%"src="../imagens/update2.png">--> </td>
